        ...
        <form action="/models/store" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input value="{{old('bobot')}}" name="bobot" type="text" class="form-control" id="bobot" placeholder="bobot" required oninvalid="this.setCustomValidity('Isian ini tidak boleh kosong !')" oninput="setCustomValidity('')">                   
                </div>
            </div>
            <hr>
