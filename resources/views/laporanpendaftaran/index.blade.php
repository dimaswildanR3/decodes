...
<section class="content card" style="padding: 10px 10px 20px 20px  ">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h4><i class="nav-icon fas fa-child my-0 btn-sm-1"></i> Laporan Pendaftaran</h3>
                <hr>
            </div>
        </div>
        <div>
            <div class="col">
                ...
                <a class="btn btn-primary btn-sm my-1 mr-sm-1 " href="/laporanpendaftaran/export_excel" role="button"><i class="fas fa-file-excel"></i> Download Excel</a>
                    ...
                    <table class="table table-hover table-head-fixed" id='tabelAgendaMasuk'>
                        ...
                        {{-- <thead>
                            <tr class="bg-light"> --}}
                                ...
                                <th><div style="width:110px;">Tahun Mengajukan</div></th>
